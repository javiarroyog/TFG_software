...
df_coauthor = pd.read_csv('./procesados/training/autor-coautor-normalizado.csv', index_col=0)
df_magazine = pd.read_csv('./procesados/training/autor-revista-normalizado.csv', index_col=0)
